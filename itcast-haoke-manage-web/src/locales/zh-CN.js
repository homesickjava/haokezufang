export default {
  ...
  'menu.home': '首页',
  'menu.ocr': '爱学习',
  'menu.ocr.index': '爱学习首页',
  'menu.ocr.tklist' : '题库',
  'menu.ocr.daan': '查看答案',
  'menu.ocr.ocrstepform': '购买会员',
  'menu.ocr.ocrstepform.ocrinfo': '',
  'menu.hotel': '酒店管理',
  'menu.hotel.index': '酒店管理',
  'menu.hotel.bendian': '本店交易',
  'menu.hotel.tonghang': '行业动态',
  'menu.hotel.jiage': '同行价格查看',
  'menu.hotel.dianping': '点评管理',
  'menu.hotel.guanjianci': '点评关键词',
  'menu.hotel.jichu': '酒店基本信息',
  'menu.hotel.yuce': '市场预测',
  'menu.hotel.settings': '设置管理',
  'menu.hotel.resou': '热搜',

  'hotel.maidian.wajue':'酒店卖点挖掘',
  'hotel.tongdian.wajue':'酒店痛点挖掘',
  'hotel.zhuanhualv.qingkuang':'酒店数据分析',
  'hotel.good.pinglun.ration':'好评率',
  'hotel.bad.pinglun.ration':'差评率',
  'hotel.reply.pinglun.ration':'回复率',
  'hotel.pinglun.fenshu':'点评分数',
  'hotel.kerenyinx.keyword':'客人印象关键词',
  'hotel.baoguang.persons':'曝光人数',
  'hotel.baoguang.persons.day':'日曝光数',
  'hotel.yuding.jianshu':'预定间数',
  'hotel.yuding.jianshu.day':'日预定间数',
  'hotel.xiaoshou.jianye':'销售间夜',
  'hotel.baoguang.ratio.myhotel':'我的酒店',
  'hotel.baoguang.ratio.hotel1':'全季酒店',
  'hotel.baoguang.ratio.hotel2':'香格里拉大酒店',
  'hotel.baoguang.ratio.hotel3':'维也纳国际酒店',
  'hotel.baoguang.ratio.hotel4':'书香世家酒店',

  'hotel.show.chart.weidu1':'曝光-浏览转化率',
  'hotel.yuding.num.weidu':'预定间数',
  'hotel.xiaoshou.num.weidu':'销售间夜',


  'menu.interview.redis1':'',
  '':'',
  '':'',
  '':'',
  '':'',
