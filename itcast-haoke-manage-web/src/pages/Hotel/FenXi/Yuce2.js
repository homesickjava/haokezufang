...
import YuceTimelineChart from "./YuceTimelineChart";
...
@connect(({ yuce, loading }) => ({
  yuce,
  loading: loading.effects['yuce/fetch'],
}))
...
*/
  ...
  render() {
    ...
    const { yuce, loading: stateLoading } = this.props;
    const {
      offlineData,
      offlineChartData,
      salesTypeData,
